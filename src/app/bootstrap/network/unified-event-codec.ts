...
case "sound": return ({ "kind": reader.field("kind").literal("sound"), ...(reader.field("origin").value === undefined ? {} : { "origin": readEventVec3(reader.field("origin"), identity) }), "actor": readActorId(reader.field("actor"), identity), "path": reader.field("path").string(), "channel": reader.field("channel").choice<"auto" | "weapon" | "voice" | "item" | "body" | 5 | 6 | 7>("auto", "weapon", "voice", "item", "body", 5, 6, 7), "attenuation": reader.field("attenuation").finite(), "volume": reader.field("volume").finite() });
...
case "effect": return ({ "kind": value["kind"], "effect": value["effect"], "actor": writeEventQ1EventEffectActor(value["actor"]), "origin": writeEventVec3(value["origin"]), "amount": value["amount"] });
...
case "sound": return ({ "kind": value["kind"], "actor": writeEventQ1EventEffectActor(value["actor"]), "origin": writeEventVec3(value["origin"]), "path": value["path"], "channel": value["channel"], "volume": value["volume"], "attenuation": value["attenuation"], "reliable": value["reliable"], "loop": value["loop"] });
...
case "music": return ({ "kind": reader.field("kind").literal("music"), "event": ({ "kind": reader.field("event").field("kind").literal("cd-track"), "track": reader.field("event").field("track").finite() }), "sequence": reader.field("sequence").finite(), "content": readContentId(reader.field("content"), identity), "seconds": reader.field("seconds").finite(), ...(reader.field("sourceEntity").value === undefined ? {} : { "sourceEntity": readEventSimulationPresentationEventQ1SourceEntity(reader.field("sourceEntity"), identity) }) });
...
case "music": return ({ "kind": value["kind"], "event": ({ "kind": value["event"]["kind"], "track": value["event"]["track"] }), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
case "q1-composition": return ({ "kind": value["kind"], "event": writeEventQ1CompositionEvent(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
case "q1-level": return ({ "kind": value["kind"], "event": writeEventQ1IntermissionResult(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
case "q2": return ({ "kind": value["kind"], "event": writeEventQ2PresentationEvent(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
case "q2-weapon": return ({ "kind": value["kind"], "event": writeEventQ2WeaponEvent(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
...
case "q2-composition": return ({ "kind": value["kind"], "event": writeEventQ2CompositionEvent(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
case "q2-rerelease": return ({ "kind": value["kind"], "event": writeEventQ2RereleaseEvent(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
case "q2-player": return ({ "kind": value["kind"], "event": writeEventQ2PlayerEvent(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
case "q3-character": return ({ "kind": value["kind"], "event": writeEventQ3CharacterPresentationEvent(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
case "q3-ballistics": return ({ "kind": value["kind"], "event": writeEventQ3SharedBallisticEvent(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) });
case "q3-source": return ({ "kind": value["kind"], "event": writeEventQ3SourceEvent(value["event"]), "sequence": value["sequence"], "content": writeContentId(value["content"]), "seconds": value["seconds"], ...(value["sourceEntity"] === undefined ? {} : { "sourceEntity": writeEventSimulationPresentationEventQ1SourceEntity(value["sourceEntity"]) }) }); } }
...
function readEventDamageDecision(reader: SaveReader, identity: UnifiedIdentityDecoder): EventDamageDecision { void identity; return { "request": readEventDamageRequest(reader.field("request"), identity), "mutations": readEventDamageDecisionMutations(reader.field("mutations"), identity), "appliedDamage": reader.field("appliedDamage").finite(), "reaction": reader.field("reaction").choice<"none" | "pain" | "death">("none", "pain", "death"), ...(reader.field("feedback").value === undefined ? {} : { "feedback": readEventDamageDecisionFeedback(reader.field("feedback"), identity) }), ...(reader.field("continuation").value === undefined ? {} : { "continuation": ({ "kind": reader.field("continuation").field("kind").literal("q1-health"), "damage": reader.field("continuation").field("damage").finite(), "take": reader.field("continuation").field("take").finite() }) }) }; }
function writeEventDamageDecision(value: EventDamageDecision): unknown { return { "request": writeEventDamageRequest(value["request"]), "mutations": writeEventDamageDecisionMutations(value["mutations"]), "appliedDamage": value["appliedDamage"], "reaction": value["reaction"], ...(value["feedback"] === undefined ? {} : { "feedback": writeEventDamageDecisionFeedback(value["feedback"]) }), ...(value["continuation"] === undefined ? {} : { "continuation": ({ "kind": value["continuation"]["kind"], "damage": value["continuation"]["damage"], "take": value["continuation"]["take"] }) }) }; }
