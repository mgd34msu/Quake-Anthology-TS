...
export class Q1RemotePresentation implements Q1ApplicationClientHost, RemotePresentationAccess {
    ...
    playerUi(actor: ActorId): PlayerUi {
        ...
        return { powerups: [], health: data.health, armor: { powered: { kind: 'none' }, regular: data.armor === 0 ? { kind: 'none' } : { kind: 'q1', points: data.armor, absorption: (data.items & 32768) !== 0 ? 0.8 : (data.items & 16384) !== 0 ? 0.6 : 0.3, item: 'q1:armor' } }, activeWeapon: item,
