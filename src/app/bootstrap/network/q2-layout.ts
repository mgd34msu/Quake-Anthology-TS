...
export function q2ApplicationLayout(protocol: Q2ProtocolIdentity): Q2ApplicationLayout {
    if (protocol.kind === 'q2-rerelease' || protocol.kind === 'q2-kex' || protocol.kind === 'q2-kex-demo')
        return { models: 62, sounds: 8254, images: 10302, lights: 10814, items: 11326, playerSkins: 11582, maxModels: 8192, maxSounds: 2048, maxImages: 512, maxConfigStrings: 12448, mapChecksum: 61, maxClients: 60, airAccelerate: 59 };
    return { models: 32, sounds: 288, images: 544, lights: 800, items: 1056, playerSkins: 1312, maxModels: 256, maxSounds: 256, maxImages: 256, maxConfigStrings: 2080, mapChecksum: 31, maxClients: 30, airAccelerate: 29 };
}
