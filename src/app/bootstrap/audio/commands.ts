export const applicationAudioCommands: readonly string[] = ["snd_restart", "cd", "music", "soundinfo", "soundlist", "play", "stopsound", "s_info", "s_list", "s_stop"];
