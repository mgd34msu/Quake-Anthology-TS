...
export function captureMovementPlayer(player: Readonly<MovementPlayer>) {
  ...
  return { version: 1, fixedPoseActive: player.fixedPoseActive, arsenalIntent, netQuakeCommand: player.netQuakeCommand, actor: savedActorId(player.actor.id), clientSlot: player.client.slot, state: saveMovement(player.state), arsenal: player.arsenal, animation: player.animation,
...
export function readMovementPlayer(reader: SaveReader, reference: ActorReference) {
  ...
  return { fixedPoseActive: reader.field("fixedPoseActive").value === undefined ? false : reader.field("fixedPoseActive").boolean(), arsenalIntent, netQuakeCommand, flight: reader.field("flight").value === undefined ? false : reader.field("flight").boolean(), actor: readSavedActor(reader.field("actor")), clientSlot: reader.field("clientSlot").integer(0), state: readMovement(reader.field("state"), reference), arsenal: readArsenal(reader.field("arsenal")), animation: readActorAnimation(reader.field("animation")),
