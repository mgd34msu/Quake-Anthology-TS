...
export interface Q3SelectedSourceHost extends Pick<Q3RecordHost, "actors" | "bodies" | "combat" | "inventory" | "callbacks">,
  ...
  Pick<Q3CombatBridgeHost, "combatProvider" | "sourceDamageModifier" | "damagePowerupOwner" | "inventoryProvider" | "movementProvider" | "armorContext" | "gameType" | "friendlyFire" | "knockback" | "intermissionQueued" | "checkHurtCarrier"> {
