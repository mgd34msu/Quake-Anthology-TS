...
import type { DecodedModel, Md5Model, Q1AliasModel } from "../../contracts/scene.ts";
...
import { md5PathsFor, md5ReplacementAllowed, q1ReplacementSkinSelection } from "../../formats/q3-model/replacements.ts";
