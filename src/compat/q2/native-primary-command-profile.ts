...
const xatrix: NativePrimaryCommandProfile = {
  ...
  items: { table: 0x4b828, stride: 76, count: 48, classname: 0, flags: 0x38, ammo: { kind: "name", offset: 0x34, label: 0x28 } },
};
const retail: NativePrimaryCommandProfile = {
  ...
  items: { table: 0x195320, stride: 192, count: 84, classname: 8, flags: 0x7c, ammo: { kind: "index", offset: 0x74 } },
};
