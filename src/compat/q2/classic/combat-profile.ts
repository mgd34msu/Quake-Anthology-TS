...
export interface ClassicCombatProfile {
  ...
  readonly client: { readonly inventory: number; readonly inventoryCount: number; readonly maxGrenades: number; readonly invincibleFrame: number; readonly userinfo: number };
  readonly entries: { readonly damage: number; readonly spawn: number; readonly free: number };
...
export const xatrixCombatProfile: ClassicCombatProfile = {
  ...
  client: { inventory: 740, inventoryCount: 256, maxGrenades: 1776, invincibleFrame: 3728, userinfo: 188 },
  entries: { damage: 0x5050, spawn: 0x19090, free: 0x19140 },
