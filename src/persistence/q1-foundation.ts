...
function sourceState(reader: SaveReader): Q1EntitySourceState {
  ...
  return { model: s("model"), frame: n("frame"), skin: n("skin"), effects: n("effects"), solid: reader.field("solid").choice("none", "trigger", "bbox", "slidebox", "bsp", "corpse"), movement: reader.field("movement").choice("none", "push", "step", "toss", "bounce", "fly", "flymissile", "noclip", "gib"),
