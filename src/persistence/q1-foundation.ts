...
function entity(reader: SaveReader): Q1SavedEntity {
  ...
  return { actor: readSavedActor(reader.field("actor")), sourceSlot: reader.field("sourceSlot").nullable(value => value.integer(0)), classname: reader.field("classname").string(), sourceOrdinal: reader.field("sourceOrdinal").nullable(value => value.integer()), state: sourceState(reader.field("state")),
...
export function readQ1FoundationCheckpoint(reader: SaveReader): Q1FoundationCheckpoint {
  ...
  return { format: reader.field("format").literal("q1-foundation"), version: reader.field("version").literal(2),
