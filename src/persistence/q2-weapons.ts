...
export function readQ2WeaponState(reader: SaveReader): Readonly<Q2WeaponState> {
  ...
  return { handReservation: handReservation(reader.field("handReservation"), weapon, phase), sourceFiring: b("sourceFiring"), weapon, lastWeapon: name("lastWeapon"), pending: name("pending"), phase, frame: n("frame"), thinkTime: n("thinkTime"), fireFinished: n("fireFinished"), fireBuffered: b("fireBuffered"), latchedAttack: b("latchedAttack"),
