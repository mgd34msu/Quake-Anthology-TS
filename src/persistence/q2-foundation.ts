...
function entity(reader: SaveReader): Q2EntityCheckpoint {
  ...
  return { actor: readSavedActor(reader.field("actor")), sourceSlot: reader.field("sourceSlot").nullable(value => value.integer(0)),
    spawn: { classname: spawn.field("classname").string(), ordinal: spawn.field("ordinal").integer(), values: spawn.field("values").list(value => ({ key: value.field("key").string(), value: value.field("value").string() })) },
