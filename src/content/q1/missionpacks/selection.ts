...
function owns(game: Q1EntityServices, player: Q1PlayerState, weapon: Q1Weapon): boolean { return game.host.inventory.count(player.actor.id, weaponItem(weapon)) > 0; }
function hasAmmo(game: Q1EntityServices, player: Q1PlayerState, weapon: Q1Weapon, required = countRequired(weapon)): boolean {
  const ammo = game.weaponAmmo(weapon); return ammo === null || game.host.inventory.count(player.actor.id, ammo) >= required;
}
function cycle(game: Q1EntityServices, player: Q1PlayerState, pack: Q1MissionPack, reverse: boolean): boolean {
...
function rogueSelected(game: Q1EntityServices, player: Q1PlayerState, impulse: number): Q1Weapon | null {
...
function hipnoticSelected(game: Q1EntityServices, player: Q1PlayerState, impulse: number): Q1Weapon | null {
  switch (impulse) {
    case 1: return "axe";
    case 2: return "shotgun";
    case 3: return "supershotgun";
...
export function missionWeaponImpulse(game: Q1EntityServices, player: Q1PlayerState, pack: Q1MissionPack, impulse: number): boolean {
