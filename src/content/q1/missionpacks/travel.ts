...
function packInventory(game: Q1EntityServices, pack: Q1MissionPack): readonly InventoryEntry[] {
...
export function decodeMissionPackTravel(game: Q1EntityServices, state: Q1TravelState, serverFlags: number, pack: Q1MissionPack): Q1TravelState {
...
export function admitMissionPackTravel(game: Q1EntityServices, actor: OwnedActor, state: Q1TravelState, pack: Q1MissionPack): undefined {
