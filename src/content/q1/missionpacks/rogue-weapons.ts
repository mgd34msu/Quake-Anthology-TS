...
function finish(game: Q1Foundation, player: Q1PlayerState, delay: number, model: string, repeating = false): boolean {
...
function missile(game: Q1Foundation, classname: string, owner: ActorId, origin: Vec3, velocity: Vec3, model: string): Q1Actor {
...
function ignoreTouch(game: Q1Foundation, entity: Q1Actor, other: ActorId): boolean {
  return entity.owner !== null && sameActor(entity.owner, other) || game.entity(other)?.solid === "trigger";
}
export function launchRogueLavaSpike(game: Q1Foundation, owner: ActorId, origin: Vec3, direction: Vec3, powered = false): Q1Actor {
...
export function fireRogueLava(game: Q1Foundation, player: Q1PlayerState): boolean {
...
function lavaTouch(game: Q1Foundation, entity: Q1Actor, other: ActorId): undefined {
...
export function launchRogueMultiGrenade(game: Q1Foundation, owner: ActorId, origin: Vec3, velocity: Vec3, angles: Vec3): Q1Actor {
...
export function fireRogueMultiGrenade(game: Q1Foundation, player: Q1PlayerState): boolean {
...
function grenadeExplode(game: Q1Foundation, grenade: Q1Actor, mini = true): undefined {
...
function splitGrenade(game: Q1Foundation, grenade: Q1Actor): undefined {
...
function multiGrenadeTouch(game: Q1Foundation, grenade: Q1Actor, other: ActorId): undefined {
...
function explodeRocket(game: Q1Foundation, rocket: Q1Actor, direct: ActorId | null): undefined {
...
function acquireRocket(game: Q1Foundation, rocket: Q1Actor): undefined {
...
function homeRocket(game: Q1Foundation, rocket: Q1Actor): undefined {
...
export function fireRogueMultiRocket(game: Q1Foundation, player: Q1PlayerState): boolean {
  if (!game.host.inventory.consume(player.actor, "rogue:ammo/multi-rockets", 1)) return false;
  const body = game.host.bodies.read(player.actor.id); if (body === null) return false;
...
export function launchRoguePlasma(game: Q1Foundation, owner: ActorId, origin: Vec3, direction: Vec3): Q1Actor {
...
export function fireRoguePlasma(game: Q1Foundation, player: Q1PlayerState): boolean {
...
function plasmaDamage(game: Q1Foundation, plasma: Q1Actor, end: Vec3): undefined {
...
function plasmaTouch(game: Q1Foundation, plasma: Q1Actor, other: ActorId): undefined {
...
export function registerRogueWeaponCallbacks(game: Q1Foundation): undefined {
