...
export function later(game: Q1Foundation, entity: Q1Actor, delay: number, name: string): undefined { return game.schedule(entity, delay, game.named.action(entity, name)); }
export function trigger(game: Q1Foundation, entity: Q1Actor): undefined {
...
export function brush(game: Q1Foundation, entity: Q1Actor): undefined {
  entity.mangle = game.body(entity).angles; entity.solid = "bsp"; entity.movement = "push";
  return game.setBody(entity, { angles: ZERO });
}
export function targetEvent(game: Q1Foundation, entity: Q1Actor, target: string, message = ""): undefined {
