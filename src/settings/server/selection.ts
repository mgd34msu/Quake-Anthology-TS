...
export function serverDefinitionsForSelection(selection: {
  ...
  if (selection.source.provider.startsWith("q2:")) return collectServerSettings(q2ServerSettingCollections(selection.match.provider, selection.combat.provider.startsWith("q2:")));
