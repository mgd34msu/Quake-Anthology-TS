...
Newer source also accepts artifact-qualified QuakeC weapon/client stage declarations, preserving original attack continuations and explicit objective handling through saves. Additional primary combat and native/QVM interface declarations remain in progress.
