...
The executable in `~/Projects/qfiles/quake-typescript` was built from `b609532` on September 20. It includes the Mods menu, corrected hook/grenade controls, mixed QuakeC/QVM/native component callbacks, owned actors and sounds, and component console commands. Its compiled GL check covered Q1 rerelease with QuakeWorld movement and Q3 Ranger, input, save/load, rendered continuation and normal quit. Whole-game performance and physical audio remain unqualified. See [installed identity and runtime evidence](docs/execution-status.md#installed-executable-and-recent-fixes).
