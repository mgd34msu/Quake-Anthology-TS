...
Regular armor and powered protection now have independent state, including saves, network events and HUD values. A regular-armor change preserves powered equipment and fuel. New saves use `QTSAVE3`; version-2 saves still load, while older executables cannot read new saves. Unified peers must support snapshot version 2. Original modules retain their damage calculations and storage rules. Borrowed powered protection inside another original module's damage routine remains under development.
