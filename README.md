...
remain in progress. Native DLL gameplay and saving remain slow; the
[performance notes](docs/functional-targets/performance.md) record measured improvements and limits. See the [shared task list](docs/functional-targets/status.md)
