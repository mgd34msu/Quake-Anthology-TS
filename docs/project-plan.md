...
The lead independently verified shared slot selection, rapid switching, outgoing presentation, source gauntlet suppression, saves and travel in representative native and mixed configurations. Rerelease CTF follows an actual q3dm11 door through its full 94-unit movement and stop. LMCTF retains native player-contact damage pulses, and attached relations survive save identity remapping. Threewave and LMCTF on moving Q3 brushes remain blocked by the native area query requiring foreign source projections. Native Q1 sky removal, general Q3 foreign observations and full Q3 saves remain unproven. Active work addresses target-owned use/damage admission and shared spatial actor observations; selected-monster admission and authored path/mission obligations remain pending. GUI/keybinding wiring is absent.
