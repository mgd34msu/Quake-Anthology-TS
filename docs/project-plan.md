...
Cross-world equipment activation remains pending. Checkpoint `47310c3` supplies Threewave, Q2 CTF and LMCTF grapple cores with their mechanics preserved, independent binding APIs, and a saved Q2 hand-grenade action. Native and offhand grenade actions reserve ammunition from the same inventory. These cores do not yet enable all three grapples or their bindings in the application. Q2 hand grenades must be independently selectable offhand on any map with any arsenal, without selecting Q2 weapons. Press/release throws a grenade; holding cooks it before release. The current weapon stays equipped.
