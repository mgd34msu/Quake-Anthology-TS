...
| W18/W19/W59 presentation | Checkpoint `423101a` fixes Q2 intensity, MD2 culling, Sarge child skins, audio queuing/frame cost and selected-character jump audio. | The installed executable has not been updated. Complete presentation coverage remains open; menu work is paused for core engine interoperability. |
