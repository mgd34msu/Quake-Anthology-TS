...
| W57/W58 bots and navigation | Checkpoint `827636f` adds Q3-derived bots to Q2 standard deathmatch, issuing normal actions under engine physics. Earlier bot checks cover movement, firing, restart and travel. | Broader content/mode admission, useful rerelease capabilities, complete navigation and team orders remain open. Retain one Q3-derived core rather than an alternate production player-bot brain. |
