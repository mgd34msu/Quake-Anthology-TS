...
The Linux x64 executable at `/home/buzzkill/Projects/qfiles/quake-typescript` is built from checkpoint `e20b6d68e94a5fabe328c8fd1d4df9d3e5cd37b5`, replacing the earlier `ca5003b` binary. Running it without arguments opens the main menu before creating a world, player or game audio. Explicit CLI game/preset launches remain supported. Bun 1.3.14 produced the 119,093,376-byte executable from immutable source; strict typing, policy and input-stability gates passed. Installation was atomic with mode `0755`.

- Source SHA-256: `8915fd1a8319160a54d11fd81fc3179fd1714254495483c2b805c738da059461`.
- Executable SHA-256: `b29f822a203c3ec01a5fbd152caff1d82fcb0bdaedf79692b8d910bd83265c87`.
- Adjacent provenance: `quake-typescript.build.json`; previous binary and sidecar: `quake-typescript.previous-20260912T150027418Z` and its `.build.json`.
...
| W18/W19/W59 presentation | Checkpoint `423101a` fixes Q2 intensity, MD2 culling, Sarge child skins, audio queuing/frame cost and selected-character jump audio. | The installed executable is updated through `e20b6d6`; see the [build record](#installed-build). Shared startup/pause menus have inspected CPU/GL captures; complete presentation coverage remains open. |
