...
Checkpoint `24fe385` reads actual Q1/Q2 weapon owners independently of Q1/Q2 map ownership, using engine join `daee0a8` to preserve repeated selected-Q1 fire. The bounded new case uses Q2 rerelease base1, Q2 movement/character and selected classic Q1 weapons. From a supported source-teleport approach lane, ordinary bot movement collects the untouched Q2 shotgun pickup into the previewed Q1 inventory, observes source respawn, reads map-owned quad, then switches from axe to shotgun and consumes ammunition while dealing damage. Root independently passed all four shared-world cases (4 tests/77 assertions); final isolated strict/policy checks passed. Q3-map foreign arsenals, remaining weapon tactics, team modes and all-map coverage remain unqualified. The installed executable remains `ca5003b`; formal acceptance counts are unchanged.

## Installed build

The Linux x64 executable at `/home/buzzkill/Projects/qfiles/quake-typescript` is built from menu checkpoint `ca5003b99faa8ee6fc1d80d76ea5ca3c3257e145`, replacing the earlier `7cbab8d` binary. Running it without arguments opens the main menu before creating a world, player or game audio. Explicit CLI game/preset launches remain supported. Bun 1.3.14 produced the 118,958,208-byte executable from immutable source; strict typing, policy and input-stability gates passed. Installation was atomic with mode `0755`.

- Source SHA-256: `9243d9c95f1be2dbdc7cedeac770f9299149c2914f0f13b6fa2cfdbb0f256134`.
- Executable SHA-256: `0b3094d78a7d7fb5d4779091ce74b751b57a33da0559851168b6bc5b7f7c79f9`.
- Adjacent provenance: `quake-typescript.build.json`; previous binary and sidecar: `quake-typescript.previous-20260912T053209Z` and its `.build.json`.
...
| W41–W51 content and composition | Selected-Q3 arsenal checks cover shared actors, movement, damage, projectiles, saves and travel. Named Q1 id1 and classic/rerelease Q2 base-program standard-match supply profiles now admit native pickups into that arsenal. | Two classic selected creatures now attach to authored encounters; full-roster admission and remaining mission obligations are still open. Arbitrary pickup replacement, other mixed arsenals, expansion supply profiles, backpacks/death drops, capacity packs and full interoperability remain incomplete. |
...
| W57/W58 bots and navigation | Checkpoint `eb0d55f` extends the same Q3-derived core to Q1 standard deathmatch with selected base-Q2 weapons; actual Q1/Q2 combat, source resets, actor reuse and composition-preserving travel pass. | Bot weapon knowledge reads actual Q1/Q2 arsenals on Q1/Q2 maps and retains existing native Q3 behavior. Remaining Q1 weapons/programs and foreign Q3 arsenal support, health/armor/powerup goals, source-ID tactical comparisons and broader modes remain open. |
| W18/W19/W59 presentation | Checkpoint `423101a` fixes Q2 intensity, MD2 culling, Sarge child skins, audio queuing/frame cost and selected-character jump audio. | The installed executable is updated through `ca5003b`; see the [build record](#installed-build). Shared startup/pause menus have inspected CPU/GL captures; complete presentation coverage remains open. |
