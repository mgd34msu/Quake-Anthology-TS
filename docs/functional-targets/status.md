...
| T06 | Console, cvars and profiles | Active | Public configuration/library callers are integrated. Finish dedicated binding ownership, menu save/exec completion feedback and initial Q1 command-line script routing. |
