...
Installed executable is `3ef462f5e2ffd86cd2c7588e293f5ffb9c1f1594`, including accepted T07/T09 source joins. Exact identity and delivery scope are recorded in [execution status](../execution-status.md). The current T10 integration below has not yet been delivered in that executable.
