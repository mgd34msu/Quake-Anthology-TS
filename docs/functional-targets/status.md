...
| T10 | Gamecode and mod execution | Complete in accepted source | Original QuakeC, classic/rerelease native modules, QVM game/client/UI adapters, foreign maps, and declared QC/native/QVM projectile components have consumers. Real mod firing/save workflows passed. Exact-artifact declarations and explicit legacy ABI limits remain; arbitrary-mod compatibility is not certified. |
