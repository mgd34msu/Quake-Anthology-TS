...
| T07 | Network connections and prediction | Active | Selectable DOSBox IPX transport is joined for NQ/Q2/Q3 with physical packet ceilings enforced. Native AF_IPX is explicitly unavailable; native DOSBox peers and the mixed unified implementation remain unqualified. Complete native peers, prediction and KEX 2023 transport. |
