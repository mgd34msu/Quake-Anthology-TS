...
| T10 | Gamecode and mod execution | Active | Native API3 and public QVM roles are joined. QVM map/full-restart and carried-client refusal handling are integrated. External NetQuake QC native networking, native rerelease mod consumers and guest bot services remain active implementation work. |
