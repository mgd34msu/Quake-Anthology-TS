...
import { BotMoveFlag, BotMoveResult } from "../../../src/bots/behavior/q3/movement-state.ts";
...
retail("authored Q2 lift keeps BSP identity through shared Q3 route execution", async () => {
  ...
  try {
    ...
    let aboard = false, sequence = 0, reached = false, elevatorActions = 0, centeredRideFrames = 0;
