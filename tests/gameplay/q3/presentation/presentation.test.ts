...
import { createModelEntity } from "../../../../src/content/q3/presentation/ref-entity.ts";
...
describe("Q3 cgame presentation", () => {
  ...
  test.skipIf(!existsSync(archivePath))("retail models and sound feed shared seat presentation", async () => {
    ...
    scene.addRefEntity(parent); parent.origin = { x: 0, y: 0, z: 0 };
    ...
    scene.renderScene(refdef); scene.clearScene(); refdef.areaMask[0] = 255;
