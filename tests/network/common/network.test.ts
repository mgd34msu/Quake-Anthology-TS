...
test("composition offer and private remote seats retain separate identities", () => {
  ...
  const recipe: ExecutableRecipe = {
    ...
    presentation: { environment: { kind: "audio-content" }, assets: provider.content, hud: provider, effects: provider, audio: provider }, engineBehavior: provider, combat: provider, inventory: provider,
